...
//C0730065 Assignment4.
{
    class Program
    {
        ...
        public void ReadTextFiles()
        {
            ...
            using (StreamReader file = new StreamReader("U:/Users/730065/Assignment/Beowulf.txt"))
            {
                int counter = 0;
                string ln;
        ...
        {
            long lineCounter = 0;
            using (StreamReader fil = new StreamReader("U:/Users/730065/Assignment/Beowulf.txt"))
            {
        ...
        {
            StreamReader reader = new StreamReader("U:/Users/730065/Assignment/Beowulf.txt");
        ...
        {
            int f = 0;
            foreach (var line in File.ReadAllLines("U:/Users/730065/Assignment/Beowulf.txt"))
            {
                f++;
